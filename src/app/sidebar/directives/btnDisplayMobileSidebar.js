...
function btnDisplayMobileSidebar(AppModel, gettextCatalog) {
    ...
    return {
        replace: true,
        template: `<button class="btnDisplayMobileSidebar-container flex"><icon data-name="burger" data-size="24" class="mauto"></icon><span class="sr-only">${I18N.displayMenu}</span></button>`,
